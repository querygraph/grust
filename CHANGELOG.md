...
- **Each work meter's balance is padded to a whole cache line.** The balance a
  ...
  seven): PageRank `path-65536` at sixteen workers 12.2 ms against 13.0 and
  31.4 before; `path-16384` 9.7 against 9.3 and 17.2; sequential WCC
  `uniform-16384` +2–3% and `uniform-65536` −0.6% against +10–11% and +7%
  before; triangles `hub-65536` at sixteen workers +3.9–4.8% against
  +5.2–6.3% before. The one-worker WCC residue is not the balance's line: a
