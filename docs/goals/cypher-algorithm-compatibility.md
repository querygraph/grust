...
| Centrality | Weighted PageRank with personalization and convergence reporting; Amphipod 0.16.0 exact degree counts and nonnegative weighted strength | Reference normalization/dangling/tolerance mapping; degree negative-weight and loop-convention qualification; closeness, harmonic, betweenness, eigenvector and HITS |
