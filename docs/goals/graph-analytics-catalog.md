...
| M6 | groups 22, 17, 19, 21, 27, 30 (no randomness, no P7) | **22 done in 0.22.0**, which also gives groups 1, 7, 8, 23 and 24 their oracle. **19 done** (`allPairsShortestPaths`). 17, 21, 27, 30 remain. |
...
| 22 Modularity/conductance | done (0.22.0) | 19 All-pairs shortest paths | done (`allPairsShortestPaths`, streamed) | 15–18, 20, 21, 23–35 | — (see Tier B) |
