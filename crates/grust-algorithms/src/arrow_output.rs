...
use crate::{
    ...
    NodeOrder, NodeTable, PageRank, PathCursor, PathView, Result, ShortestPair, ShortestPaths,
    TableType, TableValue, TopologicalOrder, buffer::Buffer,
};
...
impl ArrowResultCursor {
    ...
    fn advance(&mut self) -> Result<Option<ArrowResultBatch>> {
        ...
        match output {
            ...
            Output::Paths(_) | Output::AllPairs(..) | Output::Topology(_) => {
